...
def get_params():
    ...
    args.add_argument("-data", "--dataset", default="NELL-One", choices=["NELL-One", "Wiki-One", "Fb15k-237"])
    ...
    args.add_argument("-eta", "--eta", default=0.03, type=float)
    ...
    args.add_argument("-state_dir", "--state_dir", default="./CARE-state", type=str)
    ...
    args.add_argument("-max_nn_meta", "--max_nn_meta", default=3, type=int)
